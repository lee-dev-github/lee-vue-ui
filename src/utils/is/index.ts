...
/**
 * @desc 空值: NaN, "", {}, [], empty Map。 null or undefined will return false
 * @param value
 */
...
/**
 * @desc 判断值是否为null | undefined | empty
 * @param value
 */
export const isNilOrEmpty = (value: unknown) => {
  return isNullOrUnDef(value) || isEmpty(value)
}
