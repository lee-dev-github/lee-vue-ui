...
export interface EnumProps {
  ...
  value: string | number | boolean // 选项框值
...
export interface ColumnProps<T = any>
  ...
  enumList?: EnumProps[] | Ref<EnumProps[]> | ((params?: any) => Promise<any>) // 枚举字典
...
export type LeeTableInstance = Omit<
  InstanceType<typeof LeeTable>,
  keyof ComponentPublicInstance | keyof LeeTableProps
>
