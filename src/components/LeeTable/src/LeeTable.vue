...
import type { ColumnProps, TypeProps } from "@/components/LeeTable/src/types"
import { Refresh, Operation, Search, DCaret } from "@element-plus/icons-vue"
import { handleProp } from "@/utils"
import SearchForm from "@/components/SearchForm/SearchForm.vue"
import Pagination from "@/components/LeeTable/src/components/Pagination.vue"
import ColSetting from "@/components/LeeTable/src/components/ColSetting.vue"
...
// 接受父组件参数，配置默认值
const props = withDefaults(defineProps<LeeTableProps>(), {
  columns: () => [],
  requestAuto: true,
  pagination: true,
  initParam: {},
...
const setEnumMap = async ({ prop, enumList: enumValue }: ColumnProps) => {
  if (!enumValue) return
...
const dragSort = () => {
  ...
  Sortable.create(tbody, {
    handle: `.${ns.namespace.value}-table-main__tag--move`,
    animation: 300,
  ...
  <div :class="ns.b('box')">
    ...
    <div :class="[cardNs.b(), ns.b('main')]">
      ...
      <div :class="ns.b('header')">
        ...
        <div v-if="toolButton" :class="ns.b('header-button-ri')">
        ...
        <template v-for="item in tableColumns" :key="item">
          ...
          >
            <template #default="scope">
              ...
              <!-- sort -->
              <el-tag v-if="item.type == 'sort'" :class="ns.bem('main', 'tag', 'move')">
